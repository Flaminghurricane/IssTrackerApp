...
import { Alert, StyleSheet, Text, View,FlatList,SafeAreaView,StatusBar,Platform,Image,ImageBackground,Dimensions } from 'react-native';
...
export default class MeteorsScreen extends React.Component {
  ...
  getMeteors=()=>{
    axios
    .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=tRjSWvR5MMMBweXqDc49odTwSamrYnTRmQ1X76Zi")
    .then((response)=>{
      this.setState({
